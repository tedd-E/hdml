...
class FashionMnistData(pl.LightningDataModule):
    def __init__(self, root = '/home/bitwiz/codeden/data/mnist', batch_size = 512, 
    ...
    def trainset(self):
        return FashionMNIST(root=self.root, train=True, download = True, transform = self.train_transform)
    
    def valset(self):
        return FashionMNIST(root=self.root, train=False, download = True, transform = self.val_transform)
